...
if($mobile_browser>0) {
   // do something
   // YES MOBILE
   header("Location: http://www.landerosdesign.com/mobile/index.html"); // go to mobile URL

}
else {
   // do something else
   // NOT MOBILE
   header("Location: http://www.landerosdesign.com/index.html"); // go to desktop URL
